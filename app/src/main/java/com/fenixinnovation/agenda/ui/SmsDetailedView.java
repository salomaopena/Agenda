...
import com.fenixinnovation.agenda.myadapter.SingleGroupAdapter;
import com.fenixinnovation.agenda.receivers.DeliverReceiver;
import com.fenixinnovation.agenda.receivers.SentReceiver;
import com.fenixinnovation.agenda.services.UpdateSMSService;
...
public class SmsDetailedView extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, View.OnClickListener {
    ...
    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, SmsDetailedView.class);
        return intent;
    }
